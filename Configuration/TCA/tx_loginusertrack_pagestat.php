...
return array(
    'ctrl' => array(
        'title' => 'LLL:EXT:loginusertrack/Resources/Private/Language/locallang_db.xml:tx_loginusertrack_pagestat',
        'label' => 'uid',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'sortby' => 'crdate',
...
$GLOBALS['TCA']['tx_loginusertrack_pagestat'] = array(
    ...
    'columns' => array(
        ...
        'sesstat_uid' => array(
            'label' => 'LLL:EXT:loginusertrack/Resources/Private/Language/locallang_db.xml:tx_loginusertrack_pagestat.sesstat_uid',
            'config' => array(
                'type' => 'group',
                'internal_type' => 'db',
        ...
        'page_id' => array(
            'label' => 'LLL:EXT:loginusertrack/Resources/Private/Language/locallang_db.xml:tx_loginusertrack_pagestat.page_id',
            'config' => array(
                'type' => 'group',
                'internal_type' => 'db',
                'allowed' => 'pages',
        ...
        'hits' => array(
            'label' => 'LLL:EXT:loginusertrack/Resources/Private/Language/locallang_db.xml:tx_loginusertrack_pagestat.hits',
            'config' => array(
                'type' => 'input',
                'eval' => 'int,required',
            ),
        ...
        'tstamp' => array(
            'label' => 'LLL:EXT:loginusertrack/Resources/Private/Language/locallang_db.xml:tx_loginusertrack_stat.tstamp',
            'config' => array(
                'type' => 'input',
                'size' => 15,
                'eval' => 'datetime',
        ...
        'crdate' => array(
            'label' => 'LLL:EXT:loginusertrack/Resources/Private/Language/locallang_db.xml:tx_loginusertrack_stat.crdate',
            'config' => array(
                'type' => 'input',
                'eval' => 'int,required',
            ),
